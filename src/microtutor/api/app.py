...
from microtutor.api.routes import chat, voice, mcq, assessment, cases as cases_router, tag_review
...
_case_images_dir = BASE_DIR.parent.parent.parent / "data" / "cases" / "ID_Images" / "All_cases"
